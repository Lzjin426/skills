...
**重要提示 — 开始前 MUST 先用 Read 工具读取 [`../lark-shared/SKILL.md`](../lark-shared/SKILL.md)，其中包含认证、权限处理**
...
| Shortcut | 说明 |
|----------|------|
| [`+search`](references/lark-doc-search.md) | 搜索飞书文档、Wiki 和电子表格文件（Search v2: doc_wiki/search） |
| [`+create`](references/lark-doc-create.md) | 创建飞书文档 |
| [`+fetch`](references/lark-doc-fetch.md) | 获取飞书文档内容 |
| [`+update`](references/lark-doc-update.md) | 更新飞书文档 |
| [`+media-insert`](references/lark-doc-media-insert.md) | 在飞书文档末尾插入本地图片或文件（4步编排 + 自动回滚） |
| [`+media-download`](references/lark-doc-media-download.md) | 下载文档媒体或画板缩略图（自动检测扩展名） |
| [`+whiteboard-update`](../lark-whiteboard/references/lark-whiteboard-update.md) | `whiteboard +update` 的别名。使用 DSL、Mermaid 或 PlantUML 更新现有画板。优先使用 `whiteboard +update`；详情请参阅 lark-whiteboard skill。 |